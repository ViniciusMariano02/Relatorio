                    ...
                    <div className="filtros" >                               
                        ...
                        <Modal            
                            ...
                            className="regiao">
                                ...
                                <thead>
                                    <tr>
                                        <th className="regiao-f1">
                                            Id.Região
                                        </th>

                                        <th className="regiao-f2" scope="col">
                                            Região
                                        </th> 

                                        <th className="regiao-f3">
                                            Id. Filial
                                        </th>    

                                        <th className="regiao-f4">
                                            Qtd. Vendas
                                        </th>

                                        <th className="regiao-f5">
                                            Vlr.Médio Venda
                                        </th>

                                        <th className="regiao-f6">
                                            Vlr. Total NF-e
                                        </th>

                                        <th className="regiao-f7">
                                            Vlr. Total NFC-e
                                        </th>

                                        <th className="regiao-f8">
                                            Vlr. Venda Total
                                        </th>

                                        <th className="regiao-f9">
                                            Vlr. Custo Total
                                        </th>

                                        <th className="regiao-f10">
                                            Vlr. Lucro Venda
                                        </th>

                                        <th className="regiao-f11" >
                                            Margem
                                        </th>

                                        <th className="regiao-f12" >
                                            Markup
                                        </th>
                        ...
                        <Modal                         
                            ...
                            className="filial">
                                ...
                                <thead>
                                    <tr>
                                        <th className="filial-f1">
                                            Id.Filial
                                        </th>

                                        <th className="filial-f2" scope="col">
                                            Filial
                                        </th> 

                                        <th className="filial-f3">
                                            Qtd. Vendas
                                        </th>    

                                        <th className="filial-f4">
                                            Qtd. Itens
                                        </th>

                                        <th className="filial-f5">
                                            Méd. Itens/Cup.
                                        </th>

                                        <th className="filial-f6">
                                            Vlr. Médio Venda
                                        </th>

                                        <th className="filial-f7">
                                            Vlr. Total NF-e
                                        </th>

                                        <th className="filial-f8">
                                            Vlr. Total NFC-e
                                        </th>

                                        <th className="filial-f9">
                                            Vlr. Venda Total
                                        </th>

                                        <th className="filial-f10">
                                            Vlr. Total Credito
                                        </th>

                                        <th className="filial-f11" >
                                            Vlr. Total Líquido
                                        </th>

                                        <th className="filial-f12" >
                                            Vlr. Custo Total
                                        </th>

                                        <th className="filial-f13" >
                                            Vlr. Lucro Venda
                                        </th>

                                        <th className="filial-f14" >
                                            Vlr. Lucro Líquido
                                        </th>

                                        <th className="filial-f15" >
                                            % Margem
                                        </th>

                                        <th className="filial-f16" >
                                            Percentual
                                        </th>
                        ...
                        <Modal
                            ...
                            <thead>
                                <tr>
                                    <th className='vendedor-f1' >
                                        Id. Filial
                                    </th>

                                    <th className='vendedor-f2' >
                                        Id. Vendedor
                                    </th>

                                    <th className='vendedor-f3' >
                                        Vendedor
                                    </th>

                                    <th className='vendedor-f4' >
                                        Qtd. Vendas
                                    </th>

                                    <th className='vendedor-f5' >
                                        Vlr. Total NF-e
                                    </th>

                                    <th className='vendedor-f6'>
                                        Vlr. Total NFC-e
                                    </th>

                                    <th className='vendedor-f7'>
                                        Vlr. Venda Total
                                    </th>

                                    <th className='vendedor-f8' >
                                        Vlr. Total Cancelamento
                                    </th>

                                    <th className='vendedor-f9' >
                                        Vlr. Total Desconto
                                    </th>

                                    <th className='vendedor-f10' >
                                        Vlr. Total Credito
                                    </th>

                                    <th className='vendedor-f11' >
                                        Vlr. Total Comissão
                                    </th>

                                    <th className='vendedor-f12' >
                                        Vlr. Custo Total
                                    </th>

                                    <th className='vendedor-f13' >
                                        Vlr. Lucro Venda
                                    </th>

                                    <th className='vendedor-f14'>
                                        Vlr. Lucro Líquido
                                    </th>

                                    <th className='vendedor-f15' >
                                        Per. Lucro Líquido
                                    </th>

                                    <th className='vendedor-f16'>
                                        Percentual
                                    </th>
                                </tr>
                            </thead>
                        ...
                        <Modal
                            ...
                            <thead>
                                <tr>
                                    <th className='cliente-f1' >
                                        Id. Filial
                                    </th>

                                    <th className='cliente-f2'>
                                        Id. Cliente
                                    </th>

                                    <th className='cliente-f3' >
                                        Cliente
                                    </th>

                                    <th className='cliente-f4' >
                                        Qtd. Vendas
                                    </th>

                                    <th className='cliente-f5' >
                                        Vlr. Total NF-e
                                    </th>

                                    <th className='cliente-f6' >
                                        Vlr. Total NFC-e
                                    </th>

                                    <th className='cliente-f7' >
                                        Vlr. Venda Total
                                    </th>

                                    <th className='cliente-f8' >
                                        Vlr. Total Desconto
                                    </th>

                                    <th className='cliente-f9' >
                                        Vlr. Total Credito
                                    </th>

                                    <th className='cliente-f10' >
                                        Vlr. Custo Total
                                    </th>

                                    <th className='cliente-f11' >
                                        Vlr. Lucro Venda
                                    </th>

                                    <th className='cliente-f12' >
                                        Vlr. Lucro Líquido
                                    </th>
                                    
                                    <th className='cliente-f13' >
                                        Per. Lucro Líquido
                                    </th>

                                    <th className='cliente-f14'>
                                        Percentual
                                    </th>
                                </tr>
                            </thead>
                        ...
                        <Modal
                            ...
                            className="tipoDePagamento"> 

                            <thead>
                                <tr>
                                    <th className='tpPg-f1' >
                                        Id. Filial
                                    </th>

                                    <th className='tpPg-f2' >
                                        Dinheiro
                                    </th>

                                    <th className='tpPg-f3' >
                                        Cheque
                                    </th>

                                    <th className='tpPg-f4' >
                                        BRASILCARD
                                    </th>

                                    <th className='tpPg-f5' >
                                        Cartão de Crédito
                                    </th>

                                    <th className='tpPg-f6' >
                                        POS Crédito
                                    </th>

                                    <th className='tpPg-f7' >
                                        Cartão de Débito
                                    </th>

                                    <th className='tpPg-f8' >
                                        POS Débito
                                    </th>

                                    <th className='tpPg-f9' >
                                        Crédito Loja
                                    </th>

                                    <th className='tpPg-f10' >
                                        Duplicata Mercantil
                                    </th>

                                    <th className='tpPg-f11' >
                                        Boleto Bancário
                                    </th>

                                    <th className='tpPg-f12' >
                                        Pix
                                    </th>

                                    <th className='tpPg-f13' >
                                        Sem Pagamento
                                    </th>

                                    <th className='tpPg-f14' >
                                        Cupom de crédito
                                    </th>

                                    <th className='tpPg-f15' >
                                        Outros
                                    </th>

                                    <th className='tpPg-f16' >
                                        Desconto Total
                                    </th>

                                    <th className='tpPg-f17' >
                                        Cancelamento Total
                                    </th>

                                    <th className='tpPg-f18' >
                                        Total
                                    </th>
                        ...
                        <Modal 
                            ...
                            <thead>
                                <tr>
                                    <th className='fornecedor-f1' >
                                        Ranking
                                    </th>

                                    <th className='fornecedor-f2' >
                                        Id. Fornecedor
                                    </th>
