                            ...
                            <div>
                                <tbody>
                                    {dados.map((f5) => {
                                        return(
                                            <tr>
                                                <td className='filter-all' >{f5.idFilial}</td>
                                                
                                                <td className='filter-all' > 2 </td>

                                                <td className='filter-all' > 3 </td>

                                                <td className='filter-all' > 4 </td>

                                                <td className='filter-all' > 5 </td>

                                                <td className='filter-all' > 6 </td>

                                                <td className='filter-all' > 7 </td>

                                                <td className='filter-all' > 8 </td>

                                                <td className='filter-all' > 9 </td>

                                                <td className='filter-all' > 10 </td>

                                                <td className='filter-all' > 11 </td>

                                                <td className='filter-all' > 12 </td>

                                                <td className='filter-all' > 13 </td>

                                                <td className='filter-all' > 14 </td>

                                                <td className='filter-all' > 15 </td>

                                                <td className='filter-all' > 16 </td>

                                                <td className='filter-all' > 17 </td>

                                                <td className='filter-all' >{result}</td>
                                            </tr>
                                        )
                                    } )}
                                </tbody>
